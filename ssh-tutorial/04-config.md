...
- Learn how to avoid typing long SSH commands
- Learn how to automatically hop via an intermediate server
- Learn how to set and remember advanced settings
```
...
```{note} In case of `ProxyJump` trouble
